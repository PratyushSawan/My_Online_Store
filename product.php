...
?>
		<table class="tbl-cart" cellpadding="10" cellspacing="1">
			<tbody>
				...
				<a class="btn-primary btn-sucess" id="btnsucess" href="product.php?action=sucess"
					width="10%">Confirm</a>
				<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				<tr>
					...
					<td style="text-align:center;"><a href="product.php?action=remove&code=<?php echo $item["code"]; ?>"
...
?>
	...
	<div class="container">
		<div id="product-grid">
			<div class="txt-heading product">Products</div>
			<center class="product-section">
				<?php
					...
					<form method="post"
						...
						<div class="product-tile-footer">
							...
							<div class="cart-action"><input type="text" class="product-quantity" name="quantity"
									...
									class="btnAddAction btn btn-primary btn-sucess" /></div>
						</div>
					</form>
				</div>
				<?php
